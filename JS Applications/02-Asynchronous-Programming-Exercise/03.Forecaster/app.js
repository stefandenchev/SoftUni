    ...
    function getWeather() {
        fetch('http://localhost:3030/jsonstore/forecaster/locations')
            ...
            .then(data => {
                ...
                let locationResult = data.find(obj => obj.name === location.value);

                let currentWeatherPromise = fetch(`http://localhost:3030/jsonstore/forecaster/today/${locationResult.code}`)
                    .then(res => res.json())
                    .then(currWeather => {
                ...
                let upcomingWeatherPromise = fetch(`http://localhost:3030/jsonstore/forecaster/upcoming/${locationResult.code}`)
                    .then(res => res.json())
