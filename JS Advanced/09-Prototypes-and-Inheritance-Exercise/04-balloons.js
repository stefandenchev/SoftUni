...
let testBirthdayBalloon = new classes.BirthdayBalloon("blue", 23, "silver", 10, "Kaladin");
let ribbon = testPartyBalloon.ribbon;
let ribbonBd = testBirthdayBalloon.ribbon;

let textBd = testBirthdayBalloon.text;
